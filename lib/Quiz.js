...
var Quiz = _react2.default.createClass({
    ...
    renderAnswers: function renderAnswers(answers, questionNumber) {
        ...
        return answers.map(function (aa, key) {
            return _react2.default.createElement(
                'label',
                { className: '' + _this.getClassName('Answer'), key: key, style: { display: 'block' } },
                _react2.default.createElement('input', { className: '' + _this.getClassName('Answer_radio'), name: questionNumber, type: 'radio', value: key, onChange: _this.onChange.bind(_this, aa, questionNumber) }),
                _react2.default.createElement('span', { className: '' + _this.getClassName('Answer_text'), dangerouslySetInnerHTML: { __html: aa } })
            );
        });
    }
});
