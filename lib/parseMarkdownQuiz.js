...
exports.default = function (str) {
    return (0, _immutable.fromJS)(_markdown.markdown.parse(str.__content)).skip(1).reduce(function (reduction, value, key, iterable) {
        switch (value.get(0)) {
            case 'header':
                return reduction
            ...
            default:
                return reduction.updateIn([reduction.size - 1, 'markdown'], (0, _immutable.List)(), function (vv) {
                    return vv.push(value);
                });
